        ...
        <div className="col-lg-7 d-flex justify-content-around">
            ...
            <form className="login-form mt-6 w-100 row h-auto">
                ...
                <div>
                    ...
                    <a href="#" className="btn btn-neutral w-full w-md-max font-bold"><i className="bi bi-google"></i>&nbsp;&nbsp;SignIn With Google</a>
                </div>
            </form>

            <hr className="w-70 mx-auto  mt-10"/>

            <a href="/signup" className="text-dark btn-outline-secondary"><p className="text-sm float-end">Don&apos;t have a account ? <span className="text-primary">Register here !</span></p></a>
